...
public class StringUtils {
    ...
    /*
     * Remove the first word from input string
     * For example: if input string is "hello I am a programmer",
     * the returned output is "I am a programmer"
     * 
    ...
    /*
     * Return the first word of input string
     * For example: if input string is "hello I am a programmer",
     * the returned output is "hello"
     * 
     * @param  input the input string
     * @return  The resulting string
     */
