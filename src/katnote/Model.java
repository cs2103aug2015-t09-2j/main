...
public class Model {
     ...
     * 
     * @param taskID which will correspond to the index of the task in the
     *            dataLog.
     ...
     * 
     * @param taskID
     * @param newDate which can be an incomplete date with either the time
     *            and/or date only.
     ...
     * backup of the old data. This will also reset the undo and redo logs.
     * 
